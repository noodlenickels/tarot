    ...
    render() {
        return(this.props.status ?
            <div className="card-container middle">
                ...
                <div className="spravka-text">Для того, чтобы начать гадание, нужно нажать на кнопку "Погадать" или сказать ассистенту "погадать/погадай мне/сделай расклад".</div>
